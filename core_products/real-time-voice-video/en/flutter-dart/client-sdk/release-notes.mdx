...
1. Local device exception notification callback supports monitoring exception recovery
    ...
    For related APIs, see: [onLocalDeviceExceptionOccurred](https://www.zegocloud.com/docs/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onLocalDeviceExceptionOccurred.html)
...
3. Optimized memory usage when the media player loads preloaded resources
    ...
    For related APIs, see: [loadResourceFromMediaData](https://www.zegocloud.com/docs/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/loadResourceFromMediaData.html)
