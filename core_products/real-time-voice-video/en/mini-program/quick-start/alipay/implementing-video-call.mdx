...
sequenceDiagram
    ...
    ZEGO Express SDK-->>App: Publish state update/Quality callback <br/> [OnPublisherStateUpdate / OnPublisherQualityUpdate]

    App->>ZEGO Express SDK: Play stream <br/> [StartPlayingStream]
    ZEGO Express SDK-->>App: Play state update/Quality/Media event callback <br/> [OnPlayerStateUpdate / OnPlayerQualityUpdate / OnPlayerMediaEvent]
