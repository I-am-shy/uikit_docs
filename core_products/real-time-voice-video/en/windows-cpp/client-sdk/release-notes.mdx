...
1. Stream playing and media player support ChinaDRM video decryption

    Stream playing and media player modules support pulling ChinaDRM encrypted video streams, enabling compliant decoding and playback through the decryption module.
    <Warning title="Note">
    Please contact ZEGOCLOUD Technical Support if you need to use this feature.
    </Warning>

    For related APIs, see: [callExperimentalAPI](@callExperimentalAPI)
...
3. Fixed an issue where the preview might freeze after system wake-up from sleep
