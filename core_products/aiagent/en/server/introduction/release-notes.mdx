...
| Add Singapore node | Added a Singapore cluster with default configuration for Singapore node ASR, LLM, TTS, digital human and other services. Suitable for overseas customers to reduce latency, multi-region deployment, and privacy compliance scenarios.

<Note>

For Singapore node activation and pricing, please contact ZEGO sales.
