...
2. New APP package name verification

    Supports configuring an allowlist of valid Android app package names. The SDK automatically verifies the current app package name during login. If the device package name is not in the allowlist, login will be rejected.
    <Warning title="Note">
